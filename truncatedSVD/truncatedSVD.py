  ...
  for r_value in r_values:
    ...
    for evolution_method in evolution_methods:
      ...
      for n_batches, phi in zip(batch_splits, phis):
        print(f"Performing truncated SVD on dataset {dataset} using batch_split = {str(n_batches)}.")
        ...
        for ii in range(n_batches):
          ...
          if evolution_method == "zha-simon":
            ...
            Uk, Sigmak, VHk = model.evolve_matrix_deflated_bcg(step_dim=int(np.ceil(s_dim/n_batches)), r_dim=r_value)
